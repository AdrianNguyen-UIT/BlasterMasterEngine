...
#include "Assets/Others/Trap/Trap.h"
#include "Assets/Others/Ladder/Ladder.h"
...
void Area2::CreateScene()
{
	...
	
	{
		...
		std::shared_ptr<Object2D> bulletHead1 = std::make_shared<EnemyBulletHead>(265.0f, mapSize.height - 2970.0f, 110.0f);
		...
		std::shared_ptr<Object2D> worm3 = std::make_shared<EnemyWorm>(475.0f, mapSize.height - 2865.0f, 120.0f);
		worm3->name = "worm3";
		...
		std::shared_ptr<Object2D> worm4 = std::make_shared<EnemyWorm>(861.0f, mapSize.height - 2865.0f, 125.0f);
		worm4->name = "worm4";
		...
		std::shared_ptr<Object2D> worm5 = std::make_shared<EnemyWorm>(924.0f, mapSize.height - 2865.0f, 125.0f);
		worm5->name = "worm5";
		...
		std::shared_ptr<Object2D> crazyLadyBug1 = std::make_shared<EnemyCrazyLadybug>(1180.0f, mapSize.height - 2255.0f, 80.0f, 80.0f, 100.0f);
		crazyLadyBug1->name = "crazyLadyBug1";
		crazyLadyBug1->CreateResources();
		AddObject(crazyLadyBug1);

		std::shared_ptr<Object2D> crazyLadyBug2 = std::make_shared<EnemyCrazyLadybug>(1073.0f, mapSize.height - 2127.0f, 100.0f, 100.0f, 100.0f);
		crazyLadyBug2->name = "crazyLadyBug2";
		crazyLadyBug2->CreateResources();
		AddObject(crazyLadyBug2);

		std::shared_ptr<Object2D> crazyLadyBug3 = std::make_shared<EnemyCrazyLadybug>(1343.0f, mapSize.height - 2127.0f, 40.0f, 130.0f, 100.0f);
		crazyLadyBug3->name = "crazyLadyBug3";
		crazyLadyBug3->CreateResources();
		AddObject(crazyLadyBug3);

		std::shared_ptr<Object2D> worm6 = std::make_shared<EnemyWorm>(1230.0f, mapSize.height - 2074.0f, 120.0f);
		worm6->name = "worm6";
		worm6->CreateResources();
		AddObject(worm6);

		std::shared_ptr<Object2D> worm7 = std::make_shared<EnemyWorm>(1152.0f, mapSize.height - 2074.0f, 100.0f);
		worm7->name = "worm7";
		worm7->CreateResources();
		AddObject(worm7);

		std::shared_ptr<Object2D> bulletHead4 = std::make_shared<EnemyBulletHead>(1205.0f, mapSize.height - 1880.0f, 0.0f);
		bulletHead4->name = "bulletHead4";
		bulletHead4->CreateResources();
		AddObject(bulletHead4);

		std::shared_ptr<Object2D> bulletHead5 = std::make_shared<EnemyBulletHead>(1269.0f, mapSize.height - 1880.0f, 0.0f);
		...
		//
		//
		std::shared_ptr<Object2D> skull1 = std::make_shared<EnemySkull>(1765.0f, mapSize.height - 1914.0f);
		skull1->name = "skull1";
		skull1->CreateResources();
		AddObject(skull1);

		std::shared_ptr<Object2D> skull2 = std::make_shared<EnemySkull>(1880.0f, mapSize.height - 1914.0f);
		skull2->name = "skull2";
		skull2->CreateResources();
		AddObject(skull2);

		std::shared_ptr<Object2D> skull3 = std::make_shared<EnemySkull>(1950.0f, mapSize.height - 1914.0f);
		skull3->name = "skull3";
		...
		std::shared_ptr<Object2D> worm9 = std::make_shared<EnemyWorm>(2307.0f, mapSize.height - 1768.0f, 100.0f);
		worm9->name = "worm9";
		...
		std::shared_ptr<Object2D> worm10 = std::make_shared<EnemyWorm>(2180.0f, mapSize.height - 1383.0f, 100.0f);
		worm10->name = "worm10";
		worm10->CreateResources();
		AddObject(worm10);

		std::shared_ptr<Object2D> worm11 = std::make_shared<EnemyWorm>(2244.0f, mapSize.height - 1320.0f, 120.0f);
		worm11->name = "worm11";
		worm11->CreateResources();
		AddObject(worm11);

		std::shared_ptr<Object2D> worm12 = std::make_shared<EnemyWorm>(2180.0f, mapSize.height - 1252.0f, 90.0f);
		worm12->name = "worm12";
		...
		std::shared_ptr<Object2D> skull5 = std::make_shared<EnemySkull>(1625.0f, mapSize.height - 527.0f);
		skull5->name = "skull5";
		skull5->CreateResources();
		AddObject(skull5);

		std::shared_ptr<Object2D> bee7 = std::make_shared<EnemyBee>(1842.0f, mapSize.height - 397.0f, 7.0f);
		bee7->name = "bee7";
		bee7->CreateResources();
		AddObject(bee7);

		std::shared_ptr<Object2D> bee8 = std::make_shared<EnemyBee>(1978.0f, mapSize.height - 397.0f, 7.0f);
		bee8->name = "bee8";
		bee8->CreateResources();
		AddObject(bee8);

		std::shared_ptr<Object2D> legRobot2 = std::make_shared<EnemyLegRobot>(1984.0f, mapSize.height - 332.0f, true, 25.0f, 120.0f, 60.0f);
		legRobot2->name = "legRobot2";
		legRobot2->CreateResources();
		AddObject(legRobot2);

		std::shared_ptr<Object2D> legRobot3 = std::make_shared<EnemyLegRobot>(1817.0f, mapSize.height - 332.0f, true, 60.0f, 120.0f, 60.0f);
		...
		std::shared_ptr<Object2D> crazyLadyBug5 = std::make_shared<EnemyCrazyLadybug>(2477.0f, mapSize.height - 74.0f, 25.0f, 130.0f);
		crazyLadyBug5->name = "crazyLadyBug5";
		crazyLadyBug5->CreateResources();
		AddObject(crazyLadyBug5);

		std::shared_ptr<Object2D> crazyLadyBug6 = std::make_shared<EnemyCrazyLadybug>(2502.0f, mapSize.height - 74.0f, 70.0f, 130.0f);
	...
	for (XmlObjectGroup objectGroup : xmlMap->GetObjectGroups())
	{
		...
		if ((objectGroup.GetName() == "overhead gate"))
		{
			for (size_t jIndex = 0; jIndex < objectGroup.GetNumObjects(); ++jIndex)
			{
				XmlObject object = objectGroup.GetObjects().at(jIndex);
				float xPos = (float)object.GetX() + (float)object.GetWidth() / 2;
				float yPos = (float)mapSize.height - (float)(object.GetY() + object.GetHeight() / 2.0f);
				std::shared_ptr<Object2D> gate = std::make_shared<OverworldGate>(jIndex, xPos, yPos);
				gate->boxCollider->size = { (float)object.GetWidth(), (float)object.GetHeight() };
				AddObject(gate);
			}
		}
	}
	...
	AudioMixer::PlayWaveFile("AREA2_THEME", true);
}