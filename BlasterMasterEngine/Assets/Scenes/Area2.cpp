...
void Area2::CreateScene()
{
	...
	camera = std::make_shared<OrthographicCamera>(2635.0f, mapSize.height - 129.0f, CAMERA_WIDTH, CAMERA_HEIGHT);
	...
	{
		std::shared_ptr<Object2D> sophia = std::make_shared<Sophia>(2635.0f, mapSize.height - 129.0f);
